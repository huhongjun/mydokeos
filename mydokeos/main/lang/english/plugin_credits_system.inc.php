...
$MyCoursesHistory = "MyCoursesHistory";
$PlatformHistory = "PlatformHistory";
$USDSymbol = "USDSymbol";
$SelectPaymentMethod = "SelectPaymentMethod";
$CoursesSubscription = "CoursesSubscription";
$AmountCreditsToBuy = "AmountCreditsToBuy";
$AmountCreditsMonth = "AmountCreditsMonth";
$AmountCreditsYear = "AmountCreditsYear";
$SubscriptionAllowed = "SubscriptionAllowed";
$CoursesSubscription = "CoursesSubscription";
$UnsubscriptionAllowed = "UnsubscriptionAllowed";
...
$Option = "Option";
$CurrentPaymentOptions = "CurrentPaymentOptions";
$Length = "Length";
$Paypal = "Paypal";
$DisablePaymentOption = "DisablePaymentOption";
$SetPaypalAccount = "SetPaypalAccount";
$SetPaypalToken = "SetPaypalToken";
$MyCoursesHistory = "MyCoursesHistory";
$Substract = "Substract";
$TotalNumberOfCourses = "TotalNumberOfCourses";
$TotalNumberOfCredits = "TotalNumberOfCredits";
$CreditsSpentPerCourse = "CreditsSpentPerCourse";
$CreditsSpendsPerUser = "CreditsSpendsPerUser";
$CreditsSpendsUsers = "CreditsSpendsUsers";
$SubscriptionDataPerCourse = "SubscriptionDataPerCourse";
$SubscriptionDataPerCourse = "SubscriptionDataPerCourse";
$TotalNumberOfCredits = "TotalNumberOfCredits";
$AllowTest = "AllowTest";
$CreditsSpendsUsers = "CreditsSpendsUsers";
$PaymentOfUsers = "PaymentOfUsers";
$AllowTestexp = "AllowTestexp";
$TutorName = "TutorName";
...
$TheQuantityOfMoneySpent = "TheQuantityOfMoneySpent";
