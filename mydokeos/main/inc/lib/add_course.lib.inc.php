...
* 
* @param	integer course_tiems zml add
*/
function create_course($wanted_code, $title, $course_times, $tutor_name, $category_code, $course_language, $course_admin_id, $db_prefix, $firstExpirationDelay)
{
	...
	if(sizeof($keys))
	{
		...
		register_course($code, $visual_code, $directory, $db_name, $tutor_name, $category_code, $title, $course_times, $course_language, $course_admin_id, $expiration_date);
 ...
 * zml add course_times
 */
function register_course($courseSysCode, $courseScreenCode, $courseRepository, $courseDbName, $titular, $category, $title, $course_times, $course_language, $uidCreator, $expiration_date = "", $teachers=array())
{
	...
	if(empty ($course_times))//zml add 
	{
		$error_msg[] = "courseTimes is missing";
		$okForRegisterCourse = false;
	}
	...
	if($okForRegisterCourse)
	{
		...
		// here we must add 2 fields //zml add course_times integer
		$sql = "INSERT INTO ".$TABLECOURSE . " SET
					...
					course_times = '".Database :: escape_string($course_times) ."',
