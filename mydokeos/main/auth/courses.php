...
function display_courses_in_category($user_category_id, $showicons)
{
	...
	$sql_select_courses="SELECT course.code, course.visual_code, course.subscribe subscr, course.unsubscribe unsubscr, course.course_times,
	...
	while ($course=Database::fetch_array($result))
	{
		...
		echo "<b>".$course['title'].'<font color=red>('.$course['course_times'].')</font>'."</b><br />";
