...
$form->add_textfield('course_times', get_lang('CourseTimes'),true, array ('size' => '20')); //zml add
...
if( $form->validate())
{
	...
	$course_times = $course['course_times'];//zml add course_times
	...
	if (sizeof($keys))
	{
		...
		register_course($currentCourseId, $currentCourseCode, $currentCourseRepository, $currentCourseDbName, $tutor_name, $category, $title, $course_times, $course_language, $teacher_id, $expiration_date,$course_teachers);
