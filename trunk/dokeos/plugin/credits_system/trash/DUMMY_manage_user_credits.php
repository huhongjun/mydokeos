...
$interbreadcrumb[] = array ("url" => api_get_path(PLUGIN_PATH).'my_credits.php', "name" => 'CreditsSystem');
$tool_name = "Manage User Credits"; // title of the page (should come from the language file) 
...
else
{
	...
	if (isset ($_POST['action']))
	{
		switch ($_POST['action'])
		{
			case 'delete' :
				...
				break;
			case 'mod_credits' :
				Display :: display_confirmation_message('User Credits has been modified.');
		}
	}
	// Create a search-box
	...
	$table->set_form_actions(array ('mod_credits' => 'Modify Credits', 'delete' => get_lang('DeleteFromPlatform')));
	$table->display();
