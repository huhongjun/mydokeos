...
$form = new FormValidator('update_payment_methods','post',api_get_path(PLUGIN_PATH).'credits_system_settings.php?select=csallowteacher','_SELF');

$group = array();
$group[] = $form->createElement('radio', 'allow_teacher', '', 'Yes', 'yes');
$group[] = $form->createElement('radio', 'allow_teacher', '', 'No', 'no');
$form->addGroup($group,'paypal','Allow teacher to manage his courses credits?');

$form->addElement('submit','submit','Submit');

if( $form->validate())
{
	Display::display_confirmation_message('changes saved.');
}
