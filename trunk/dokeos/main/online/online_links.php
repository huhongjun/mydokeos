...
<tr>
  ...
  <td width="55%"><input type="text" name="link_name" size="10" maxlength="50" value="<?php if($action == 'edit') echo htmlspecialchars($link_name,ENT_QUOTES,$charset); ?>" style="width: 95px;"></td>
</tr>
<tr>
  <td width="45%"><?php echo get_lang('LinkURL'); ?> :</td>
  <td width="55%"><input type="text" name="link_url" size="10" maxlength="100" value="<?php if($action == 'edit') echo htmlspecialchars($link_url); else echo 'http://'; ?>" style="width: 95px;"></td>
</tr>
<tr>
...
<tr>
  <td colspan="2" align="center">
	<input type="submit" value="<?php echo htmlspecialchars(get_lang('Ok'),ENT_QUOTES,$charset); ?>">
  </td>
</tr>
</table>
</form>
...
<tr>
  ...
  <td width="1%" valign="middle"><a href="<?php echo api_get_self(); ?>?action=edit&link=<?php echo $enreg['id']; ?>"><img src="../img/edit.gif" border="0" alt="" title="<?php echo htmlspecialchars(get_lang('Modify'),ENT_QUOTES,$charset); ?>"></a></td>
  <td width="1%" valign="middle"><a href="<?php echo api_get_self(); ?>?action=delete&link=<?php echo $enreg['id']; ?>" onclick="javascript:if(!confirm('<?php echo addslashes(htmlspecialchars(get_lang('ConfirmYourChoice'),ENT_QUOTES,$charset)); ?>')) return false;"><img src="../img/delete.gif" border="0" alt="" title="<?php echo htmlspecialchars(get_lang('Delete'),ENT_QUOTES,$charset); ?>"></a></td>
</tr>
