...
$langWarningResponsible  = "Use this script only after backup. E_leaning team is not responsible if you lost or corrupted data";
...
$langMainDB = "Main E_leaning database (DB)";
...
$langDBSettingIntro = "The install script will create the E_leaning main database(s). Please note that E_leaning will need to create several databases. If you are allowed to use only one database by your Hosting Service, E_leaning will not work, unless you chose the option \"One database\".";
...
$langSingleDb = "Use one or several DB for E_leaning";
...
$langDokeosURL = "URL of E_leaning";
$langUserDB = "User DB";
$langInstallationLanguage = "Installation Language";
$ReadThoroughly = "Read thoroughly";
$DokeosNeedFollowingOnServer = "For E_leaning to work, you need the following on your server";
$WarningExistingDokeosInstallationDetected = "Warning!<br />The installer has detected an existing E_leaning platform on your system.";
...
$DokeosInstallation = "E_leaning Installation";
$InstallDokeos = "Install E_leaning";
...
$Version_ = "Version";
$UpdateFromDokeosVersion = "Update from E_leaning";
$WelcomToTheDokeosInstaller = "Welcome to the E_leaning Installer";
...
$YouHaveMoreThanXCourses = "You have more than %d courses on your E_leaning platform ! Only %d courses have been updated. To update the other courses, %sclick here %s";
