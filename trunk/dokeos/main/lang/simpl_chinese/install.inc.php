...
$DokeosInstallation = "Dokeos安装";
$InstallDokeos = "安装Dokeos";
...
$Version_ = "版本";
$UpdateFromDokeosVersion = "从Dokeos更新";
$WelcomToTheDokeosInstaller = "欢迎来到Dokeos安装";
...
$SecurityAdvice = "安全建议";
$YouHaveMoreThanXCourses = "你有多个%d课程在你的Dokeos平台！只有%d课程已更新。更新其他课程，%s点击这里%s";
