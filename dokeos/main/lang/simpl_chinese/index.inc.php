...
$UsageDatacreated = "使用数据创建";
$SessionView = "由会议显示课程排序";
$CourseView = "显示课程的全部列表";
$DropboxFileAdded = "添加投递箱文件";
$NewMessageInForum = "新消息发布在论坛";
$FolderCreated = "创建新文件夹";
$LinkAdded = "添加新链接";
