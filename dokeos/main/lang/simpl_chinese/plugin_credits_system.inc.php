...
$DefaultPaymentOptionCreditsexp = "默认支付选项需要的学习币数量";
$AllowTeacher = "允许教师";
$AllowTeacher = "允许教师";
...
$AmountCreditsMonth = "按月统计";
$AmountCreditsYear = "按年统计";
...
$simpl_chinese = "简体中文 ";
$DeleteOption = "删除选项";
$AccessExpiredOn = "课程已到期";
$ThereIsNotData = "没有可导出的数据";
?>