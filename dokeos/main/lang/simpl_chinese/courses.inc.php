...
$langManage = "平台管理";
$langEnrollToCourseSuccessful = "注册成功";
$langSubCat = "子分类";
$langUnsubscribeNotAllowed = "不允许从这门课程注销.";
$langCourseAdminUnsubscribeNotAllowed  = "你是这门课程的管理员.";
$CourseManagement = "自由学习";
$SortMyCourses = "课程排序";
$SubscribeToCourse = "申请新课";
$UnsubscribeFromCourse = "注销课程";
$CreateCourseCategory = "创建课程分类";
$CourseCategoryAbout2bedeleted = "确认想要删除这个课程分类吗? 这个课程分类中的课程将要被移到课程分类外";
...
$YouAreNowUnsubscribed = "课程已注销";
$ViewOpenCourses = "浏览公开课程";
$ErrorContactPlatformAdmin = "发生未知错误。请联系平台管理员。";
$CourseRegistrationCodeIncorrect = "课程代码不正确";
$CourseRequiresPassword = "课程需要密码";
$SubmitRegistrationCode = "提交注册代码";
