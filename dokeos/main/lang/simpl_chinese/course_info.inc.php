...
$langDescriptionDeleteCourse = "点击这个链接是为了从服务器上课程里消除任何痕迹。<br><br>这个功能必须被处理以预防极端！";
$langDescriptionCopyCourse = "复制课程区域或另一个课程区域部分。你需要最少2门课程使用这个工具。";
$DescriptionRecycleCourse = "这个工具清空课程。它删除文档，论坛，链接。并允许你选择你想删除的部分或决定删除整个。";
$QuizEmailAlert = "在新的测验提交时电子邮件警告";
$QuizEmailAlertActivate = "当用户提交新的测验答案时激活电子邮件发送";
$QuizEmailAlertDeactivate = "在新的测验答案提交时禁止电子邮件警告";
$AllowUserImageForum = "论坛里的用户图片";
$AllowUserImageForumActivate = "在论坛里显示用户图片";
$AllowUserImageForumDeactivate = "在论坛里隐藏用户图片";
$AllowLearningPathTheme = "允许学习路径主题";
