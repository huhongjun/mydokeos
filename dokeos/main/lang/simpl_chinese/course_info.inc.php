...
$WorkEmailAlert = "通过电子邮件警告工作提交";
$WorkEmailAlertActivate = "在新工作提交上启用电子邮件警告";
$WorkEmailAlertDeactivate = "在新工作提交上禁用电子邮件警告";
$DropboxEmailAlert = "通过电子邮件警告投递箱提交";
$DropboxEmailAlertActivate = "在新的投递箱提交上启用电子邮件警告";
$DropboxEmailAlertDeactivate = "在新的投递箱提交上禁用电子邮件警告";
$AllowUserEditAgenda = "允许用户编辑日程";
$AllowUserEditAgendaActivate = "用户激活课程日程编辑";
$AllowUserEditAgendaDeactivate = "用户禁止课程日程编辑";
$AllowUserEditAnnouncement = "允许用户编辑课程公告";
$AllowUserEditAnnouncementActivate = "用户能编辑";
$AllowUserEditAnnouncementDeactivate = "禁止用户编辑";
$OrInTime = "或在";
$CourseRegistrationPassword = "课程注册密码";
$langDescriptionDeleteCourse = "从服务器上永久删除本课程。<br><br>危险程度较高，请谨慎使用！";
$langDescriptionCopyCourse = "复制本课程所有内容或部分内容到另一个课程。使用这个工具至少需要2门课程。";
$DescriptionRecycleCourse = "重置课程。可以选择删除整个课程或自定义选择要删除的部分，如文档，论坛，链接等。";
$QuizEmailAlert = "通过电子邮件警告新测试提交";
$QuizEmailAlertActivate = "当用户提交新的测试答案时激活电子邮件发送";
$QuizEmailAlertDeactivate = "在新的测试答案提交时禁止电子邮件警告";
$AllowUserImageForum = "论坛里的用户图片";
$AllowUserImageForumActivate = "在论坛里显示用户图片";
$AllowUserImageForumDeactivate = "在论坛里隐藏用户图片";
$AllowLearningPathTheme = "允许在线学习主题";
$AllowLearningPathThemeAllow = "允许";
$AllowLearningPathThemeDisallow = "不允许";
?>